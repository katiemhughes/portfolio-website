    ...
    return (
        <div className="footerContainer">
            <div className="socialIcons">
                <SocialIcon network="twitter" bgColor="#00000" url="https://twitter.com/katiemhughes_" />
                <SocialIcon network="github" bgColor="#00000" url="https://github.com/katiemhughes" />
                <SocialIcon network="linkedin" bgColor="#00000" url="http://www.linkedin.com/in/katiemhughes95" />
                <SocialIcon network="email" bgColor="#00000" url="mailto:katie.m.hughes@hotmail.co.uk" />
